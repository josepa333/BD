...
public partial class ProyectoBasesJAREntities9 : DbContext
{
    public ProyectoBasesJAREntities9()
        : base("name=ProyectoBasesJAREntities9")
    {
    ...
    public virtual ObjectResult<Rivales_Result> Rivales(Nullable<System.DateTime> fecha, string equipo1, string equipo2)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Rivales_Result>("Rivales", fechaParameter, equipo1Parameter, equipo2Parameter);
    }
    ...
    public virtual ObjectResult<historialArbitros_Result> historialArbitros(string competicion, Nullable<decimal> temporada)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<historialArbitros_Result>("historialArbitros", competicionParameter, temporadaParameter);
    }


    public virtual ObjectResult<infoArbitros_Result> infoArbitros(string competicion, Nullable<decimal> temporada)
    {
